...
def main(ir_dir='./test_imgs/ir', vi_dir='./test_imgs/vi', save_dir='./SCGRFuse', fusion_model_path='./model/Fusion/fusionmodel_final.pth'):
...
if __name__ == '__main__':
    ...
    ## model
    parser.add_argument('--model_path', '-M', type=str, default='./model/Fusion/fusion_model4.pth')
    ## dataset
    ...
    parser.add_argument('--save_dir', '-save_dir', type=str, default='./SCGRFuse')
